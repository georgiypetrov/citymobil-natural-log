...
df_train = pd.read_csv("../data_old/train.csv/train.csv")
#df_train = pd.read_csv("../data/test_additional.csv")
df_test = pd.read_csv("../data_old/test.csv")
df_val = pd.read_csv("../data_old/validation.csv")
